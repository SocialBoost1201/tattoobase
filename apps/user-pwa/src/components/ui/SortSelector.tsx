...
export default function SortSelector({ currentSort }: { currentSort: string }) {
  ...
  return (
    <select
      ...
      className="bg-neutral-900 border border-neutral-800 hover:border-neutral-700 text-neutral-300 text-base md:text-xs font-bold rounded-full px-3 py-1.5 outline-none cursor-pointer transition-colors appearance-none pr-6"
